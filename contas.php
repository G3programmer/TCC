...
<body>
    <header class="cabecalho">
        ...
        <nav id="menu">
            ...
            <ul class="menu">
                ...
                <li><a href="estoque.php" target="_blank">Visualizar os produtos</a></li>
    ...
    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.9.2/dist/umd/popper.min.js" integrity="sha384-5nA/Uft8AHT9n9p+5DxiBJGVl3LmYYbs4k6e7uFS/NVUb5+slJHCG5dB0+jhAs5Y" crossorigin="anonymous"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js" integrity="sha384-kQhL2e3Ez08lSKTn8tpT6qQ9U5esNm1xJMSx5Oe1x6TFo/V2SMZ0J4mP7tqDRgVq" crossorigin="anonymous"></script>
</body>
</html>
