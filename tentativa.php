...
<body>
    <header class="cabecalho">
        ...
        <nav id="menu">
            ...
            <ul class="menu">
                <li>
                    <a href="indexLogado.html">Página inicial</a>
    ...
    <main class="home">
        <div class="content">
            <div id="carouselExampleIndicators" class="carousel slide" style="justify-content: center;">
                ...
                <div class="carousel-inner" style="width:70pc; justify-items: center;">
                    <div class="carousel-item active">
                        <img src="src/imagem/produtos/slide1.png" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="src/imagem/produtos/slide2.png" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="src/imagem/produtosy/slide3.png" class="d-block w-100" alt="..." style="width:1000px;">
                    </div>
                </div>
            </div>
    </main>
