...
CREATE TABLE IF NOT EXISTS `Vanguard`.`relatorio` (
  ...
  `usuario_estado_id` INT NOT NULL,
  `usuario_cidades_id` INT NOT NULL,
  PRIMARY KEY (`relatorio_id`, `usuario_id`, `usuario_estado_id`, `usuario_cidades_id`),
  INDEX `fk_relatorio_usuario_has_relatorio1_idx` (`usuario_id` ASC, `usuario_estado_id` ASC, `usuario_cidades_id` ASC),
  CONSTRAINT `fk_relatorio_usuario_has_relatorio1`
    FOREIGN KEY (`usuario_id` , `usuario_estado_id` , `usuario_cidades_id`)
    REFERENCES `Vanguard`.`admin_relatorio` (`usuario_id` , `usuario_estado_id` , `usuario_cidades_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
